...
import { Heart, Building, Mail, Lock, User, Eye, EyeOff, CheckCircle2, ArrowLeft, X, Phone, MapPin, Globe, FileText } from 'lucide-react';
...
const GetStartedModal: React.FC<Props> = ({ isOpen, onClose, onSwitchToLogin }) => {
        ...
        {step === 'role' && (
          <div className="p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-all font-medium text-gray-700 mb-4"
            >
